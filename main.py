...
from experience_store_dqn import TrainedDQN
...
def main():
    ...
    print("memory len : {}".format(len(agent.replay_buffer)))

    data_path = "./data/" + args.env +".pt"
    torch.save(agent.replay_buffer.memory, data_path)
